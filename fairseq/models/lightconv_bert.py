...
from . import (
    ExtraFeatDecoder, ExtraFeatEncoder, ExtraFeatModel, FairseqLanguageModel,
    register_model, register_model_architecture,
)


@register_model('lightconv_bert')
class LightConvBertModel(ExtraFeatModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        encoder = LightConvBertEncoder(args, src_dict, encoder_embed_tokens)
        decoder = LightConvBertDecoder(args, tgt_dict, decoder_embed_tokens)
        return LightConvBertModel(encoder, decoder)


@register_model('lightconv_bert_lm')
class LightConvBertLanguageModel(FairseqLanguageModel):
...
class LightConvBertEncoder(ExtraFeatEncoder):
    """
...
class LightConvBertDecoder(ExtraFeatDecoder):
    """
    ...
    def forward(self, prev_output_tokens, encoder_out, bert_tgt=None, incremental_state=None):
        ...
        if bert_tgt:
            ...
            padding = torch.zeros(x.size()).cuda()
...
@register_model_architecture('lightconv_bert_lm', 'lightconv_bert_lm')
def base_lm_architecture(args):
    # TODO add bert args here...
...
@register_model_architecture('lightconv_bert_lm', 'lightconv_bert_lm_gbw')
...
@register_model_architecture('lightconv_bert', 'lightconv_bert')
...
@register_model_architecture('lightconv_bert', 'lightconv_bert_wmt_en_de')
def lightconv_wmt_en_de(args):
    base_architecture(args)


@register_model_architecture('lightconv_bert', 'lightconv_bert_wmt_en_de_big')
...
@register_model_architecture('lightconv_bert', 'lightconv_bert_wmt_en_fr_big')
def lightconv_wmt_en_fr_big(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    lightconv_wmt_en_de_big(args)


@register_model_architecture('lightconv_bert', 'lightconv_bert_wmt_zh_en_big')
